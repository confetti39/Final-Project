...
## "gestures" folder와 database를 만든다.
...
## folder_name directory와 database를 만든다
...
def store_images(g_id):
   ...
   while True:
      ...
      contours = cv2.findContours(thresh.copy(), cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)[1] #0에서 1로 바꿈
